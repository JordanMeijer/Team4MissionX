...
export default function SideBar(props) {
  const StudentButtonContents = [
    {link:"/studentprojectbuilder", buttonText:'LEARNING OBJECTIVES', image:ObjectiveIconLight, darkImage:ObjectiveIconDark},
    {link:"/studentprojectbuilder1", buttonText:'INSTRUCTIONS', image:StepsLight, darkImage:StepsDark},
    {link:"/studentprojectbuilder2", buttonText:'VIDEO TUTORIAL', image:VideoLight, darkImage:VideoDark},
    {link:"/studentprojectbuilder3", buttonText:'MAKE PROJECT', image:NewProjLight, darkImage:NewProjDark},
    {link:"/studentprojectbuilder4", buttonText:'SUBMIT PROJECT', image:SubmitProjLight, darkImage:SubmitProjDark},
    {link:"/studentprojectbuilder5", buttonText:'BONUS CHALLENGE', image:PrizeLight},
    {link:"/studentprojectbuilder6", buttonText:'TAKE THE QUIZ', image:ListLight},   
  ]
