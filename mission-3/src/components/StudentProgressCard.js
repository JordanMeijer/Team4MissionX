...
export default function StudentProgressCard({studentName, projectsCompleted}) {
  ...
  const ProjectEllipse =numberOfProjectsStudentProgressCard.map(numberOfProjectsStudentProgressCard => {
    if (projectsCompleted.includes(numberOfProjectsStudentProgressCard)) {
      return (
        <div key={numberOfProjectsStudentProgressCard} className="ProjectEllipseCompleted">{numberOfProjectsStudentProgressCard}</div>
      )
    }
    else {
      return (
        <div key={numberOfProjectsStudentProgressCard} className="ProjectEllipse">{numberOfProjectsStudentProgressCard}</div>
      )
    }
  })
